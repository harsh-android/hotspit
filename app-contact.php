    ...
    <div id="main-wrapper">
        ...
        <aside class="left-sidebar with-vertical">
            ...
            <div class="brand-logo d-flex align-items-center justify-content-between">
                <a href="src/main/index.html" class="text-nowrap logo-img">
          <img src="src/assets/images/logos/logo-light.svg" class="dark-logo" alt="Logo-Dark" />
          <img src="src/assets/images/logos/logo-dark.svg" class="light-logo" alt="Logo-light" />
        </a>
            ...
            <div class="scroll-sidebar" data-simplebar>
                ...
                <span class="hide-menu ps-1">User Profile</span>
                    ...
                    <span class="hide-menu">Profile Two</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link indigo-hover-bg" href="../main/app-email.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-indigo-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">Email</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link info-hover-bg" href="../main/app-calendar.html" aria-expanded="false">
                ...
                <span class="hide-menu ps-1">Calendar</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link success-hover-bg" href="../main/app-kanban.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-success-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">Kanban</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link primary-hover-bg" href="../main/app-chat.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">Chat</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link secondary-hover-bg" href="../main/app-notes.html" aria-expanded="false">
                ...
                <span class="hide-menu ps-1">Notes</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link success-hover-bg" href="../main/app-contact.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-success-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">Contact Table</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link warning-hover-bg" href="../main/app-contact2.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-warning-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">Contact List</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link danger-hover-bg" href="../main/app-invoice.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-danger-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">Invoice</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link indigo-hover-bg" href="../main/page-pricing.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-indigo-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">Pricing</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link info-hover-bg" href="../main/page-faq.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-info-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">FAQ</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link primary-hover-bg" href="../main/page-account-settings.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                  <iconify-icon icon="solar:user-circle-line-duotone" class="fs-6"></iconify-icon>
                </span>
                ...
                <span class="hide-menu ps-1">Classes</span>
                        ...
                        <!-- =================== -->
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link info-hover-bg" href="../main/attendance.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-info-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">Form Editor</span>
                    ...
                    <span class="hide-menu">Tinymce Editor</span>
                        ...
                        <!-- =================== -->
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link warning-hover-bg" href="../main/form-wizard.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-warning-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">Form Wizard</span>
                        ...
                        <!-- =================== -->
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link primary-hover-bg" href="../main/form-repeater.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">Sample Pages</span>
                    ...
                    <span class="hide-menu">Session Timeout</span>
                        ...
                        <!-- =================== -->
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link secondary-hover-bg" href="../main/icon-tabler.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-secondary-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">Tabler Icon</span>
                        ...
                        <!-- =================== -->
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link primary-hover-bg" href="../main/icon-solar.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                ...
                <span class="hide-menu ps-1">Solar Icon</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link success-hover-bg" href="../main/authentication-error.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-success-subtle rounded-1">
                  <iconify-icon icon="solar:danger-circle-line-duotone" class="fs-6"></iconify-icon>
                </span>
                ...
                <span class="hide-menu ps-1">Two Steps</span>
                    ...
                    <span class="hide-menu">Boxed Two Steps</span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link primary-hover-bg" href="../main/authentication-maintenance.html" aria-expanded="false">
                <span class="aside-icon p-2 bg-primary-subtle rounded-1">
                ...
                <div class="card bg-primary-subtle mb-0 shadow-none">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between gap-3">
                            ...
                            <a href="../main/authentication-login.html" class="position-relative" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Logout">
                                            ...
                                            <div class="row">
                                                <div class="col-8">
                                                    <div class=" ps-7 pt-7">
                                                        ...
                                                        <div class="row align-items-center py-3">
                                                            <div class="col-8">
                                                                <a class="fw-semibold text-dark d-flex align-items-center lh-1 bg-hover-primary" href="javascript:void(0)">
                                                                    <iconify-icon icon="solar:question-circle-line-duotone" class="fs-6 me-2"></iconify-icon>Frequently Asked Questions</a>
                                                            </div>
                                                            <div class="col-4">
                                                ...
                                                <div class="col-4 ms-n4">
                                                    <div class="position-relative p-6 border-start h-100">
                                                        ...
                                                        <ul class="">
                                                            <li class="mb-3">
                                                                <a class="fw-semibold text-dark bg-hover-primary" href="../main/page-pricing.html">Pricing Page</a>
                                                            </li>
                                                            <li class="mb-3">
                                                                <a class="fw-semibold text-dark bg-hover-primary" href="../main/authentication-login.html">Authentication Design</a>
                                                            </li>
                                                            <li class="mb-3">
                                                                <a class="fw-semibold text-dark bg-hover-primary" href="../main/authentication-register.html">Register Now</a>
                                                            </li>
                                                            <li class="mb-3">
                                                                <a class="fw-semibold text-dark bg-hover-primary" href="../main/authentication-error.html">404 Error Page</a>
                                                            </li>
                                                            <li class="mb-3">
                                                                <a class="fw-semibold text-dark bg-hover-primary" href="../main/app-notes.html">Notes App</a>
                                                            </li>
                                                            <li class="mb-3">
                                                                <a class="fw-semibold text-dark bg-hover-primary" href="../main/page-user-profile.html">User Application</a>
                                                            </li>
                                                            <li class="mb-3">
                                                                <a class="fw-semibold text-dark bg-hover-primary" href="../main/page-account-settings.html">Account Settings</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                              ...
                              See All Messages
                                ...
                                <div class="w-100 ps-3 ms-1">
                                  ...
                                  <span class="fs-3 d-block mt-1 text-muted">Account Settings</span>
                                                            ...
                                                            <a href="../main/app-email.html" class="dropdown-item px-7 d-flex align-items-center py-6">
                                ...
                                <div class="w-100 ps-3 ms-1">
                                  ...
                                  <span class="fs-3 d-block mt-1 text-muted">Messages & Emails</span>
                                                            ...
                                                            <a href="../main/app-notes.html" class="dropdown-item px-7 d-flex align-items-center py-6">
