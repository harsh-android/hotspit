  ...
  <div class="scroll-sidebar" data-simplebar>
    ...
    <nav class="sidebar-nav">
      <ul id="sidebarnav" class="mb-4 pb-2" class="accordion" id="demo">
        ...
        <!-- Other -->
        <li class="sidebar-item accordion-item <?= in_array($current_page, ['shop-list.php', 'add-shop.php', 'paper-dye.php', 'add-dye.php', 'workers-list.php', 'add-workers.php', 'dealer-list.php', 'add-dealer.php', 'banking-list.php', 'sadi-stock-list.php', 'add-sadi.php', 'add-process.php', 'add-banking.php']) ? 'selected' : '' ?>">
          ...
          <div class="accordion-collapse collapse <?= in_array($current_page, ['shop-list.php', 'add-shop.php', 'paper-dye.php', 'add-dye.php', 'workers-list.php', 'add-workers.php', 'dealer-list.php', 'add-dealer.php', 'banking-list.php', 'sadi-stock-list.php', 'add-sadi.php', 'add-process.php', 'add-banking.php']) ? 'show' : '' ?>" id="three" data-bs-parent="#demo">
            <div class="accordion-body">
              <ul class="list-unstyled ms-4">
