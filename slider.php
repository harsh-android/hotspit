  ...
  <div class="scroll-sidebar" data-simplebar>
    ...
    <nav class="sidebar-nav">
      <ul id="sidebarnav" class="mb-4 pb-2" class="accordion" id="demo">
        ...
        <!-- Other -->
        <li class="sidebar-item accordion-item <?= in_array($current_page, ['shop-list.php', 'add-shop.php', 'paper-dye.php', 'add-dye.php', 'workers-list.php', 'add-workers.php', 'dealer-list.php', 'add-dealer.php', 'banking-list.php', 'sadi-stock-list.php', 'add-sadi.php', 'add-process.php', 'add-banking.php','sadi-stock-detail.php','add-single-sadi-stock.php']) ? 'selected' : '' ?>">
          ...
          <div class="accordion-collapse collapse <?= in_array($current_page, ['shop-list.php', 'add-shop.php', 'paper-dye.php', 'add-dye.php', 'workers-list.php', 'add-workers.php', 'dealer-list.php', 'add-dealer.php', 'banking-list.php', 'sadi-stock-list.php', 'add-sadi.php', 'add-process.php', 'add-banking.php', 'sadi-stock-detail.php','add-single-sadi-stock.php']) ? 'show' : '' ?>" id="three" data-bs-parent="#demo">
            <div class="accordion-body">
              <ul class="list-unstyled ms-4">
        ...
        <!-- <li class="sidebar-item accordion-item">
          <a class="sidebar-link sidebar-link primary-hover-bg accordion-button" data-bs-toggle="collapse" href="#four">
            ...
            <span class="hide-menu ms-2 ps-1">Main Stock</span>
          </a>
          <div class="accordion-collapse collapse" id="four" data-bs-parent="#demo">
            <div class="accordion-body">
              <ul class="list-unstyled ms-4">
              <li class="list-item mb-3"><a href="sadi-stock-list.php" class="nav-link text-black">Sadi</a></li>
            </ul>
            </div>
          </div>
        </li> -->
          ...
          <div class="accordion-collapse collapse <?= in_array($current_page, ['add-kapad-cutting.php', 'add-sheet-work.php']) ? 'show' : '' ?>" id="five" data-bs-parent="#demo">
            <div class="accordion-body">
              <ul class="list-unstyled ms-4">
                ...
                <li class="list-item mb-3"><a href="add-process.php" class="nav-link text-black">Asign Work</a></li>
              </ul>
            </div>
          </div>
        </li>
            ...
            <div class="card bg-light-primary">
              <div class="card-body">
                <div class="text-center">
                  <img
                    src="src/assets/images/backgrounds/education-blocks.png"
                    width="136"
                    height="136"
                    class="mt-n9"
                    alt=""
