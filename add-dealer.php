...
if (isset($_POST['submit'])) {
  ...
  if ($isupdate) {
    $in = "UPDATE `dealer` SET `name`='$shopName', `owner_name`='$ownerName', `mobile_number`='$mobileNumber', `gst_number`='$gstNumber', `address`='$address' WHERE `id`='$id'";
  } else {
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4"><?php echo $isupdate ? 'Edit' : 'Add' ?> Dealer</h5>
