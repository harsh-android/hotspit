...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $quee = mysqli_query($conn, "SELECT * FROM nidel_expence WHERE `id`='$id'");
...
if (isset($_POST['submit'])) {
   ...
   $sql_update = "UPDATE `nidel_expence` SET `use_qty`='$use_qty',`price`='$price' WHERE `id`='$id'";
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Edit 23 Nidel Expenses</h5>
              <div class="card">
                <div class="card-body">
                  <form method="post">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary">Submit (23 Nidel)</button>
                  </form>
                </div>
              </div>
            </div>
