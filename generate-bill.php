                  ...
                  ?>
                                        ...
                                        <div id="sadityperesult">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="diomondType"
                                                    name="diomondType">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" id="sadityperesult">
                                            <div class=" col-lg-4 col-12 mb-3">
                                                ...
                                                <?php 
                                                  ...
                                                  ?>
                                                <select class="form-control" id="color<?php echo $i; ?>"
                                            ...
                                            <div class=" col-lg-4 col-12 mb-3">
                                                ...
                                                <input type="number" name="qty<?php echo $i; ?>" class="form-control"
                                                    id="qty" placeholder="10">
                                            </div>

                                            <dl̥iv class=" col-lg-4 col-12 mb-3">
                                                <label for="price" class="form-label">Price</label>
                                                <input type="number" name="price<?php echo $i; ?>" class="form-control"
                                                    id="price" placeholder="1000">
                                            </dl̥iv>
                                        </div>
