...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $isupdate = true;
  $quee = mysqli_query($conn, "SELECT * FROM shop WHERE `id`='$id'");
...
if (isset($_POST['submit'])) {
  ...
  if ($isupdate) {
    $in = "UPDATE `shop` SET `name`='$shopName', `owner_name`='$ownerName', `mobile_number`='$mobileNumber', `gst_number`='$gstNumber', `address`='$address' WHERE `id`='$id'";
  } else {
    $in = "INSERT INTO shop(`name`,`owner_name`,`mobile_number`,`gst_number`,`address`) VALUES ('$shopName','$ownerName','$mobileNumber','$gstNumber','$address')";
  }
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4"><?php echo $isupdate ? 'Edit' : 'Add' ?> Shop</h5>
