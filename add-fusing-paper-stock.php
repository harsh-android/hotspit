...
if (isset($_POST['submit'])) {
  ...
  if ($isupdate) {
    $in = "UPDATE `fusing_paper_stock` SET `type`='$name',`qty`='$paperQut',`price`='$price',`shop`='$shop' WHERE `id`='$id'";
  } else {
    $in = "INSERT INTO fusing_paper_stock(`type`,`qty`,`price`,`shop`,`date`) VALUES ('$name','$paperQut','$price','$shop','$today')";
  }
            ...
            <div class="card-body">
              ...
              <div class="card">
                <div class="card-body">
                  <form method="post">
                    <div class="mb-3">
                      <label for="paperType" class="form-label">Fusing Paper Type</label>
                      <?php
                      $paperque = mysqli_query($conn, "SELECT * FROM fusing_paper_type");
                    ...
                    <div class="mb-3">
                      <label for="paperQut" class="form-label">Fusing Paper Quanitity</label>
                      <input type="number" name="paperQut" class="form-control" id="paperQut" placeholder="10" value="<?php echo $isupdate ? $editRes['qty'] : ''; ?>">
                    </div>
