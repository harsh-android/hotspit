...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $quee = mysqli_query($conn, "SELECT * FROM less_fiting WHERE `id`='$id'");
...
if (isset($_POST['submit'])) {
   ...
   $sql_update = "UPDATE `less_fiting` SET `use_qty`='$use_qty',`price`='$price' WHERE `id`='$id'";
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Edit Less Fiting Expenses</h5>
              <div class="card">
                <div class="card-body">
                  <form method="post">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary">Submit (Less Fiting)</button>
                  </form>
                </div>
              </div>
            </div>
