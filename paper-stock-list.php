...
if (isset($_GET['d_id'])) {
  ...
  $sql_delete = "DELETE FROM `paper_stock` WHERE `id` = $dId";
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr class="search-items">
                            <td>
                              <span class="usr-name"><?php @$typeData = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM paper_type WHERE `id`='$typeId'"));
                                                      echo @$typeData["name"];
                                                      ?></span>
                            </td>
                            <td>
                            ...
                            <td>
                              <div class="action-btn">
                                <a href="add-paper-stock.php?id=<?php echo $row['id']; ?>" class="text-primary edit">
                                  <i class="ti ti-edit fs-5"></i>
                                </a>
                                <a href="paper-stock-list.php?d_id=<?php echo $row['id']; ?>" class="text-dark delete ms-2" onclick="return confirmDelete()">
